...
<html lang="es">
	<head>
		<meta charset="utf-8">
		<title>Framework básico en php</title>
				...
				<div id="formWrapper">
					<div class="formWrapper">
						...
						<form action="<?php echo URL;?>User/signIn" name="signIn" method="post">
							...
							<input name="signInBtn" id="signInBtn" type="submit" value="Entrar" required/>
							<div class="smallText">
					...
					<div class="formWrapper hidden">
						...
						<form action="<?php echo URL;?>User/signUp" name="signUp" method="post">
							...
							<input name="username" type="text" placeholder="Username" required/>
							<input name="password" type="password" placeholder="Password" required/>
							<input name="email" type="email" placeholder="user@server.com" required/>
							<input name="signUpBtn" id="signUpBtn" type="submit" value="Registrarme" required/>
							<div class="smallText">
